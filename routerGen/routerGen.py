...
if __name__ == "__main__":
	...
	parser.add_argument('-b','--bw', help='spec bw rsvp', help='specify different RSVP bw than 10000 (default)', required=False, choices=['1000', '10000', '100000', '1000000'], default="10000")
